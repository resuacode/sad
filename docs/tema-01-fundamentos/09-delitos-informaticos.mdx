...
3. **Discusión en clase**: Al final de cada presentación se abrirá un debate sobre las medidas de prevención y protección que se podrían haber implementado para evitar el delito.
...
El informe debe contener una portada, un índice y una bibliografía/webgrafía.

En la portada debe aparecer el título del trabajo, los nombres de los miembros del grupo y el curso.
:::
