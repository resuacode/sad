...
1. **Investigación de casos**: Cada grupo seleccionará tres delitos informáticos o incidentes y buscará casos reales de cada uno para después realizar una investigación sobre los hechos, las leyes aplicables y las consecuencias legales.
    - Deberán analizar como el incidente afectó a la confidencialidad, integridad y disponibilidad (CIA Triad) de la información, identificar las vulnerabilidades explotadas y las posibles implicaciones legales.
    - Deberá coordinarse con los demás grupos que tengan delitos en común para no repetir los casos.
...
| Criterios                       | Excelente (4) | Bueno (3) | Aceptable (2) | Deficiente (0-1) |
|----------------------------------|---------------|-----------|---------------|----------------|
...
| Análisis de leyes y vulnerabilidades (20%)     | Análisis profundo y bien fundamentado. | Análisis adecuado pero con algunas lagunas. | Análisis superficial o poco claro. | Análisis ausente o incorrecto. |
| Soluciones propuestas (20%)        | Soluciones innovadoras y bien justificadas. | Soluciones adecuadas pero con poca justificación. | Soluciones poco claras o poco justificadas. | Soluciones ausentes o inadecuadas. | 
...
| Participación del grupo (10%)          | Todos los miembros del grupo participan activamente. | La mayoría de los miembros participan. | Poca participación de algunos miembros. | Ausencia de participación del grupo. |
