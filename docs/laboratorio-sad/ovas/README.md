...
|-----|--------|-----------------|-------------------|
| **WindowsServer2022-SAD.ova** | ~8 GB | `a1b2c3d4...` | [Descargar](enlaces/windows-server.md) |
| **Windows11-Client-SAD.ova** | ~6 GB | `e5f6g7h8...` | [Descargar](enlaces/windows-client.md) |
| **Ubuntu-Server-SAD.ova** | ~3 GB | `i9j0k1l2...` | [Descargar](enlaces/ubuntu-server.md) |
| **Kali-Security-SAD.ova** | ~4 GB | `m3n4o5p6...` | [Descargar](enlaces/kali-security.md) |
| **Debian-Storage-SAD.ova** | ~2 GB | `q7r8s9t0...` | [Descargar](enlaces/storage-backup.md) |
